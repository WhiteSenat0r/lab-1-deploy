      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] bg-white rounded-xl shadow-lg w-[480px] max-h-[85vh] overflow-y-auto focus:outline-none">
          <div className="p-6">
            ...
            {/* Provider badge */}
            <div className="mb-5 mt-5 p-3.5 border border-gray-200 rounded-md flex items-center gap-3 bg-gray-50">
              ...
              <span className="text-sm font-normal text-gray-900">Anthropic</span>
            </div>
